...
PulseCap has **no paid gates** and no active subscription checkout (v6.6.0). The shipped app is a full offline PWA with My Plan / Personalized Program Intelligence. Do not show prices, paid unlock claims, or fake Pro restrictions until monetization is implemented.
...
- Do not market cloud AI / LLM features while Smart Coach remains rules-based.
