...
- Playwright audit: every visible text colour vs **computed** background on all screens × 375/390/430 × both themes (not just `--text` vs `--bg`). Gallery regen at v6.34.0. SW `pulsecap-v114`.
